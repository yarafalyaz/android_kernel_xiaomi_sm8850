...
<p align="center">
<img src="https://raw.githubusercontent.com/YuzakiBahlil/Bahlil_Kernel_CI_Center/main/docs/kokuban_logo.png" alt="Logo" width="150">
</p>

<p align="center">
<a href="https://github.com/YuzakiBahlil/android_kernel_xiaomi_sm8850/releases"><img src="https://img.shields.io/github/v/release/YuzakiBahlil/android_kernel_xiaomi_sm8850?style=for-the-badge&logo=github&color=blue" alt="GitHub release"></a>
...
3. **刷入内核**：从本项目 [Releases 页面](https://github.com/YuzakiBahlil/android_kernel_xiaomi_sm8850/releases) 下载对应版本，并在 Recovery 中刷入内核 `zip` 包。
...
所有最新构建版本均发布于 [**Releases 页面**](https://github.com/YuzakiBahlil/android_kernel_xiaomi_sm8850/releases)。
...
3. **Flash the Kernel**: Download the appropriate package from the [Releases page](https://github.com/YuzakiBahlil/android_kernel_xiaomi_sm8850/releases) and flash the kernel `zip` through Recovery.
...
All current builds are published on the [**Releases Page**](https://github.com/YuzakiBahlil/android_kernel_xiaomi_sm8850/releases).
